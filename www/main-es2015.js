...
let AppComponent = class AppComponent {
    constructor(authService, menu, platform, router, splashScreen, statusBar, storage, userData, swUpdate, toastCtrl) {
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["NgModule"])({
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_5__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_19__["environment"].firebaseConfig),
...
let CheckTutorial = class CheckTutorial {
    ...
    canLoad() {
        return this.storage.get('ion_did_tutorial').then(res => {
            if (res) {
                this.router.navigate(['/app', 'tabs', 'allblogs']);
                return false;
            }
            else {
                return true;
...
let AuthService = class AuthService {
    constructor(afAuth, route, router, db) {
        ...
        this.appUser$ = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(user => {
            if (user) {
                this.db.doc(`appusers/${user.uid}`).valueChanges().forEach(result => console.log(result));
    ...
    emailSignIn(email, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            localStorage.setItem('returnUrl', returnUrl);
            const credential = yield this.afAuth.auth.signInWithEmailAndPassword(email.toString().trim(), password);
    ...
    checkUsername(username) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let k = yield this.db.doc(`usernames/${username}`).get().toPromise()
                .then(docSnapshot => {
                let b = true;
    ...
    updateUsername(username, currentUser) {
        let data = {
    ...
    login() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const returnUrl = this.route.snapshot.queryParamMap.get('returnUrl') || this.router.url;
            localStorage.setItem('returnUrl', returnUrl);
            const credential = yield this.afAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_4__["auth"].GoogleAuthProvider());
            return this.updateUserData(credential.user);
        });
    }
    logout() {
...
module.exports = __webpack_require__(/*! /home/art/Documents/portfolio/test/src/main.ts */"./src/main.ts");
