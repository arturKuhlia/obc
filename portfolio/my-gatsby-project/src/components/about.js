...
const About = ({ data }) => {
  const {
    frontmatter: { title,  dbs, lns, frs, about_image },
    html,
  } = data;
console.log(dbs,lns)
    ...
    <StyledSection id="about">
      ...
      <StyledAboutContainer>
        ...
        <div>
          ...
          <strong>Programming & Query languages:</strong>

 <TechList techs={lns } />
  <br/>
   <strong>Front-End adn Back-End Frameworks:</strong>
 <TechList techs={frs } />
 <br/>
   <strong>Database Programs:</strong>
 <TechList techs={dbs } />
        </div>
      </StyledAboutContainer>
    </StyledSection>
